...
адресом сервера и путём к логам 30 строк из трёх файлов доехали до ClickHouse,
имя файла на месте, кавычки и обратный слеш целы; позиция переживает
перезапуск без дублей.
